...
const News = () => {
    return (
        <div className="container mt-4">
            <h2 style={{ textAlign: 'left' }}>News Category</h2>
            <div className="row">
                {newLists.map((news) => (
                    <div key={news.id} className="col-md-3 mb-4">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title" style={{ textAlign: 'left' }}>{news.title}</h5>
                                <p className="card-text" style={{ textAlign: 'left' }}>{news.description}</p>
